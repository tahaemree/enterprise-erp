        ...
        <div className="space-y-6 p-6 animate-in fade-in duration-500">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex gap-2">
                    <Skeleton className="h-10 w-32 motion-safe:animate-pulse" style={{ animationDelay: "50ms" }} />
                    <Skeleton className="h-10 w-32 motion-safe:animate-pulse" style={{ animationDelay: "75ms" }} />
                </div>
            </div>
            ...
            <Skeleton className="h-96 rounded-xl motion-safe:animate-pulse" style={{ animationDelay: "200ms" }} />
        </div>
    )
}
